...
const PostAndFeed = () => {
  return (
    ...
    <View style={{marginBottom:40,paddingTop:60}}>
          ...
          <View style={{top:44,left:20,flexDirection:'row'}}>
          <View style={styles.rectangle2}>
            <Text style={{fontSize:14,color:'white',left:265}}>75%</Text>
          </View>
          <View style={styles.rectangle}>
            <Text style={{fontSize:14,color:'white',left:20}}>YES</Text>
          </View>
          ...
          <View style={{top:44,left:20,flexDirection:'row',paddingTop:25}}>
          <View style={styles.second2}>
            <Text style={{fontSize:14,color:'white',left:265}}>25%</Text>
          </View>
          <View style={styles.second}>
            <Text style={{fontSize:14,color:'white',left:20}}>NO</Text>
          </View>
          ...
          <View style={{top:44,left:20,flexDirection:'row',paddingTop:25,paddingBottom:10}}>
          <View style={styles.third2}>
            <Text style={{fontSize:14,color:'white',left:265}}>10%</Text>
          </View>
          <View style={styles.third1}>
            <Text style={{fontSize:14,color:'white',left:20}}>DON'T </Text>
            <Text style={{fontSize:14,color:'white',left:20}}>KNOW</Text>
          </View>
